...
| --- | --- | --- |
| [`DGP-001`](drafts/DGP-001.md) | Draft | Establish the Deepstate Inc endowment, activate controlled minting, and atomically replace the live Rewarder with Rewarder V2. |
